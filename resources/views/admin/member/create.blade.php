...
@section('content')
    <div class="container-fluid mt-4">
        ...
        <div class="card">
            <h3 class="text-center mt-3">Create Member</h3>
            <form action="{{route('member.store')}}" class="p-4" method="post">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="learn_date" class="form-control" value="{{old('learn_date')}}">
