...
class CategoryController extends Controller {
    ...
    public function store( Request $request ) {
        ...
        return redirect()->route( 'category.index' )->with( 'create', 'Category create success' );
    }
    ...
    public function update( Request $request, $id ) {
        ...
        return redirect()->route( 'category.index' )->with( 'update', 'Category update success' );
    }
    ...
    public function search( Request $request ) {
        $category = Category::where( 'name', 'like', '%' . $request->get( 'searchData' ) . '%' )
            ->orderBy( 'id', 'desc' )
            ->paginate( 10 );
